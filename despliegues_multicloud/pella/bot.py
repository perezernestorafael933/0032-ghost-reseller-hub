"""
=============================================================================
CYBERVAULT KEYS BOT - PELLA.APP SINGLE-WORKER EDITION
Bot: @cybervault_keys_bot | Token: 8853535007:AAF6Gm9ap4P11e1I9UAHYiPg8gcyEAQEe8M
=============================================================================
"""
...
def tg_post(endpoint, payload):
    try:
        ...
        if he.code == 409:
            print("⚠️ [409 CONFLICT] Otra instancia concurrente detectada en Telegram. Pausando 5s...")
        else:
    ...
    if "message" in update:
        ...
        if text == "/start" or text == "/catalogo":
            txt = (
                ...
                f"🚀 *Entrega automatizada e instantánea vía Bunny API.*\n\n"
                f"👤 *Tu ID:* `{u_id}`\n"
        ...
        if data == "menu":
            tg_post("editMessageText", {
                ...
                "reply_markup": {
                    "inline_keyboard": [
                        [{"text": "🛍️ Catálogo en Vivo", "callback_data": "catalog"}],
            ...
            tg_post("editMessageText", {
                "chat_id": chat_id, "message_id": msg_id,
                "text": "📂 *CATÁLOGO CYBERVAULT (BUNNY LIVE):*",
                "parse_mode": "Markdown",
...
def polling_worker():
    offset = 0
    print("⚡ Iniciando Polling exclusivo para CyberVault Bot...")
